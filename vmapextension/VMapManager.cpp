...
namespace VMAP
{
    ...
    */
	...
	if (not iInstanceMapTrees.containsKey(pMapId))
	  printf("No such map id\n");
        return(height);
    }
 ...
 /*   float MapTree::raycast(Vector3 pos,Vector3 dir)
    {
      float dist = inf();
      Ray ray = Ray::fromOriginAndDirection(pos,dir);
      float maxDist = VMapDefinitions::getMaxCanFallDistance();
      dist = getIntersectionTime(ray, maxDist, false);
      return dist;
    }*/
    //=========================================================
