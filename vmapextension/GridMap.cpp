...
bool GridMap::loadData(char *filename)
{
        ...
        header.versionMagic == uint32(MAP_VERSION_MAGIC))
    {
        ...
        {
            cout << "Error loading map area data" << endl;
            fclose(in);
            return false;
        }
        // loadup height data
        ...
        {
            cout << "Error loading map height data" << endl;
            fclose(in);
            return false;
        }
        // loadup liquid data
        ...
        {
            cout << "Error loading map liquids data" << endl;
            fclose(in);
            return false;
        }
        fclose(in);
    ...
    cout << "Map file " << filename << " is non-compatible version (outdated?). Please, create new using ad.exe program." << endl;
    fclose(in);
    return false;
}
